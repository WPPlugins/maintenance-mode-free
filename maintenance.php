...
if ( ! function_exists( 'maintenance_style_script_load' ) ) {
	function maintenance_style_script_load() {
		...
		/* Styles */
		wp_enqueue_style( 'bootstrap-css', MAINTENANCE_URL . 'templates/assets/css/bootstrap.min.css', array(),
			'20160519',
			'all' );
		wp_enqueue_style( 'maintenance-style-css', MAINTENANCE_URL . 'templates/assets/css/style.css', array(),
			'20160519', 'all' );
		wp_enqueue_style( 'maintenance-responsive-css', MAINTENANCE_URL . 'templates/assets/css/responsive.css',
			array(),
			'20160519', 'all' );
		...
		wp_enqueue_script( 'pulgins-js', MAINTENANCE_URL . 'templates/assets/js/pulgins.js', array(
			'jquery'
		), 20160519,
			true );

		wp_enqueue_script( 'respond-js', MAINTENANCE_URL . 'templates/assets/js/respond.js', array(
			'jquery'
		), 20160519,
			true );


		wp_enqueue_script( 'scripts-js', MAINTENANCE_URL . 'templates/assets/js/scripts.js', array(
			'jquery'
		), 20160519,
			true );
	}
...
if ( ! function_exists( 'maintenance_script_load' ) ) {
	function maintenance_script_load() {
		...
		wp_enqueue_script( 'admin-scripts', MAINTENANCE_URL . 'admin/inc/admin-script.js', array( 'jquery' ), null,
			true );
